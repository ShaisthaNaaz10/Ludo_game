...
class Ludo:
    ...
    def take_initial_control(self):
        ...
        top.iconbitmap("C:\\Users\\Delll\\Downloads\\ludo_gif.gif")
...
if __name__ == '__main__':
    ...
    window.iconbitmap("C:\\Users\\Delll\\Downloads\\ludo_gif.gif")
    block_six_side = ImageTk.PhotoImage(Image.open("C:\\Users\\Delll\\Downloads\\6_block.png").resize((33, 33), Image.ANTIALIAS))
    block_five_side = ImageTk.PhotoImage(Image.open("C:\\Users\\Delll\\Downloads\\5_block.png").resize((33, 33), Image.ANTIALIAS))
    block_four_side = ImageTk.PhotoImage(Image.open("C:\\Users\\Delll\\Downloads\\4_block.png").resize((33, 33), Image.ANTIALIAS))
    block_three_side = ImageTk.PhotoImage(Image.open("C:\\Users\\Delll\\Downloads\\3_block.png").resize((33, 33), Image.ANTIALIAS))
    block_two_side = ImageTk.PhotoImage(Image.open("C:\\Users\\Delll\\Downloads\\2_block.png").resize((33, 33), Image.ANTIALIAS))
    block_one_side = ImageTk.PhotoImage(Image.open("C:\\Users\\Delll\\Downloads\\1_block.png").resize((33, 33), Image.ANTIALIAS))

    ludo = Ludo(window,block_six_side,block_five_side,block_four_side,block_three_side,block_two_side,block_one_side)
    #window.bind_all("<Return>",ludo) 
    #canvas.create_text(250,250, text = 'Play!',fill ="white",font = "Consolas 18")
    #j=canvas.find_all()
